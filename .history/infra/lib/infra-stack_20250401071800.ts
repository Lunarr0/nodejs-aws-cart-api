...
export class InfraStack extends cdk.Stack {
  constructor(scope: Construct, id: string, props?: cdk.StackProps) {
   ...
   /*  const dbInstance = new rds.DatabaseInstance(this, 'Database', {
    ...
    // To use existing RDS instance, replace the dbInstance creation with:
  const dbInstance = rds.DatabaseInstance.fromDatabaseInstanceAttributes(this, 'ExistingDatabase', {
    instanceIdentifier: 'database-1',
    instanceEndpointAddress: 'database-1.cofasu0aiudo.us-east-1.rds.amazonaws.com',
    port: 5432,
    securityGroups: [dbSecurityGroup]
  });
    ...
    const nestLambda = new lambda.Function(this, 'NestJsLambda', {
      ...
      environment: {
        NODE_ENV: 'production',
        DB_HOST: 'database-1.cofasu0aiudo.us-east-1.rds.amazonaws.com',,
        DB_PORT: '5432',
