        ...
        bundling: {
          ...
          local: {
            tryBundle(outputDir: string) {
              ...
              `cp -r ${projectRoot}/* ${outputDir}/`,
              
              // Copy package files
              `cp ${path.join(__dirname, '../../package.json')} ${outputDir}/`,
              `cp ${path.join(__dirname, '../../package-lock.json')} ${outputDir}/`,
              
              // Install production dependencies in the output directory
              `cd ${outputDir} && npm install --production`
                ];
